        ...
        <div className="hidden dark:text-white lg:flex flex-col items-center gap-8 fixed right-10 top-[30%] z-50 h-auto w-20 p-4">
          ...
          <div>
            ...
            {clickedSection === "home" || (scrollY < 725 && clickedSection === "") ? (
              <div  className="text-[14px] pr-3 pt-1 font-medium" data-aos="fade-left">Home</div>
            ) : (
              ""
            )}
          </div>
          ...
          <div>
            ...
            {clickedSection === "aboutUs" || (scrollY >= 725 && scrollY < 1424 && clickedSection === "") ? (
              <div className="flex flex-col items-center text-[14px] pr-3 pt-1 font-medium my-1" data-aos="fade-left">
                <p>About</p>
                <p>LunarEdge</p>
              </div>
            ) : (
          ...
          <div>
            ...
            {clickedSection === "hawaMahal" || (scrollY >= 1424 && scrollY < 2033 && clickedSection === "") ? (
              <div className="text-[14px] pr-3 pt-1 font-medium text-nowrap" data-aos="fade-left">Hawa Mahal</div>
            ) : (
              ""
            )}
          </div>
          ...
          <div>
            ...
            {clickedSection === "journey" || (scrollY >= 2033 && scrollY < 2742 && clickedSection === "") ? (
              <div className="text-[14px] pr-3 pt-1 font-medium text-nowrap" data-aos="fade-left">Our Journey</div>
            ) : (
              ""
            )}
          </div>
          ...
          <div>
            ...
            {clickedSection === "values" || (scrollY >= 2742 && scrollY < 3380 && clickedSection === "") ? (
              <div className="text-[14px] pr-3 pt-1 font-medium" data-aos="fade-left">Values</div>
            ) : (
              ""
            )}
          </div>
          ...
          <div>
            ...
            {clickedSection === "visionMission" || (scrollY >= 3380 && scrollY < 4656 && clickedSection === "") ? (
               <div className="text-[14px] pr-3 pt-1 font-medium text-nowrap" data-aos="fade-left">Vission & Mission</div>
            ) : (
              ""
            )}
          </div>
          ...
          <div>
            ...
            {clickedSection === "technology" || (scrollY >= 4656 && scrollY <= 5460 && clickedSection === "") ? (
              <div className="text-[14px] pr-3 pt-1 font-medium" data-aos="fade-left">Technology</div>
            ) : (
              ""
            )}
          </div>
          ...
          <div>
            ...
            {clickedSection === "contact" || (scrollY > 5460 && clickedSection === "") ? (
              <div className="text-[14px] pr-3 pt-1 font-medium text-nowrap" data-aos="fade-left">Contact Us</div>
            ) : (
              ""
            )}
          </div>
