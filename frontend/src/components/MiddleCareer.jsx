  ...
  return (
    <div className="border-2 w-full border-black dark:border-white p-2 md:p-6 rounded-xl flex flex-row lg:justify-between items-start md:items-center">
      <div className="mb-4 md:mb-0 w-[70%] lg:w-auto text-left">
        ...
        />
        <div className="flex text-xs md:text-sm flex-row space-x-2 md:space-x-4 mt-4 text-gray-600 dark:text-white">
    ...
    <div className="bg-white dark:bg-[#131313] min-h-screen w-full flex flex-col justify-center items-center">
      <div className="w-[95%] md:w-[80%] px-4 py-8">
        <div className="flex flex-col justify-center items-center py-2">
          <h1 className="text-center text-3xl md:text-4xl font-semibold text-black mb-[8rem]">Openings</h1>
          {user?.role === 'ADMIN' ? (
            <button
              className="w-[30%] md:w-auto text-xs md:text-sm bg-gradient-to-r from-[#ff5757] to-[#8c52ff] text-white px-2 py-2 md:px-6 md:py-3 rounded-3xl md:font-semibold md:tracking-wider"
