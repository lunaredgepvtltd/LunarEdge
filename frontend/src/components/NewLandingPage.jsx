    ...
    <div className="relative  w-full md:h-screen h-[450px] flex ">
      <div className="md:w-[44%] w-[100%] relative h-[375px]  md:h-full">
        <img
          ...
          alt="Picture of Moon"
          className="absolute -left-[80%] md:h-[95%] h-full w-full  animate-spin-slow"
        />
      </div>

      <div className="absolute left-[20%] w-[80%] md:w-[80%] h-full p-3 md:p-8 md:flex items-center gap-4">
