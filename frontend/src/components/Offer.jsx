...
const Offer = ({key,service,content}) => {
  return (
    <div className='w-[300px] h-[300px] md:w-[400px] md:h-[300px] bg-blue-100 flex flex-col p-6 shadow-xl rounded-xl md:m-6 cursor-pointer hover:bg-white transition-all duration-300 ease-in' key={key}>
