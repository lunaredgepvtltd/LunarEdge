...
const Offer = ({key,service,content}) => {
  ...
  return (
    ...
    data-aos-delay="200"
    className='flex flex-col justify-between h-full bg-blue-100 p-4 shadow-xl hover:shadow-md hover:shadow-blue-600 rounded-xl cursor-pointer hover:bg-white transition-all duration-200 ease-in hover:scale-95' 
    key={key}
  >
