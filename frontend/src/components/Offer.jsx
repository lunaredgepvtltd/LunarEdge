...
const Offer = ({key,service,content}) => {
  ...
  return (
    ...
    key={key}
  >
    <h2 className='text-center text-xl md:text-2xl lg:text-3xl font-semibold pt-5 w-full'>
      {service}
    </h2>
    <span className='text-center text-sm lg:text-lg pt-8 text-slate-700 w-auto '>
      {content}
    </span>
  </div>
  )
