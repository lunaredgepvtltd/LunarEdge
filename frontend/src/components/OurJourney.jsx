...
const OurJourney = ({title,subtitle,content,vidiosrc,vidiotitle}) => {
  return (
    <div className="flex w-full h-[600px] px-9">
      <div className="w-[50%] h-[80%] text-2xl font-light flex flex-col justify-evenly p-4">
      ...
      <div className="w-[50%] relative flex items-center justify-center">
        ...
        <div className="absolute text-white text-3xl font-semibold w-[60%] text-center rounded-lg">
          {vidiotitle}
        </div>
      </div>
    </div>
