...
const OurVision = () => {
  return (
    <div className="h-[600px]  w-[95%] mx-auto flex md:flex-row flex-col-reverse px-4 md:px-9">
      <div className="md:w-[50%] w-full  relative flex items-center justify-center">
        ...
        <div className="absolute text-black md:text-5xl text-2xl font-semibold md:w-[80%] w-[80%] text-center rounded-lg">
          Customer Centric Approach
        </div>
      </div>

      <div className="md:w-[50%]  w-full  h-[23%] md:h-[90%]  xl:text-5xl lg:text-4xl  md:text-3xl px-[3%] text-sm flex flex-col font-normal justify-evenly ">
