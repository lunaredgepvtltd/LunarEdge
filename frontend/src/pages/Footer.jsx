          ...
          <div>
            ...
            <ul className="text-sm">
              ...
              <li className="flex gap-2 items-center">
                ...
                <p className="text-blue-900 dark:text-white hover:underline underline-offset-2 transition-all duration-300 whitespace-nowrap">
              ...
              <li className="flex gap-2 items-center">
                ...
                <p className="text-blue-900 dark:text-white hover:underline underline-offset-2 transition-all duration-300">
